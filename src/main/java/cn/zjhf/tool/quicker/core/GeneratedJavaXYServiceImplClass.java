 ...
 */
public class GeneratedJavaXYServiceImplClass extends AbstractGeneratedJavaTemplateClass {


    public GeneratedJavaXYServiceImplClass(GeneratorParam generatorParam, TableInfo tableInfo) {
